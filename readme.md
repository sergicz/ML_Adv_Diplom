...
4. API Flask-приложения (по умолчанию адрес http://127.0.0.1:5001), поддерживаются GET, POST
 ...
 - предсказание на дату http://127.0.0.1:5001/predict, входной json {"target_date":"2024-02-11"}